...
All three screenshots are existing public assets by Kai, copied unchanged at his request. No fictional employer interface or architecture was created. Asset URLs and third-party photo licenses are retained in `public/credits.txt`, accessible from the Projects page.
...
- `what-i-made-map.png`: 390 × 844, the public repository’s fictional sample map screenshot. The source app’s complete media attribution is preserved to retain the provenance of any visible thumbnail fragments.
